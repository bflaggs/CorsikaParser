// To compile:
// g++ -O0 -fbounds-check muonReaderSTANDARD.cpp -o muonReaderSTANDARD -std=c++11 -lm
...
int main (int argc, char *argv[]) {
  ...
  for (unsigned int k = 1; k < argc; ++k) {
    ...
    if (!(file_.find(".long") != std::string::npos)) {
      ...
      thinWeight300 = round(thinWeight300);
      ...
      cout << nMuons << " " << nMuons300 << " " << nMuons500 << " " << nMuons1000 << " "
           << muonThin300 << " " << thinWeight300 << " " << muonThin500 << " " << thinWeight500 << " "
