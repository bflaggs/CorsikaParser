...
# Remove final 4 points for Auger (b/c of denser slant depth sampling)
#=========================================================================
# Sibyll star only has sampling of longitudinal profiles in 5 g/cm2 steps!
#=========================================================================
del depths[-2:]
del positrons[-2:]
del electrons[-2:]
